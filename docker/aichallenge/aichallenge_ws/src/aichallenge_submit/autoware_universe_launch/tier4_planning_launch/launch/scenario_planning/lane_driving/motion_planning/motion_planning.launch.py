...
def launch_setup(context, *args, **kwargs):
    ...
    obstacle_avoidance_planner_component = ComposableNode(
        package="obstacle_avoidance_planner_custom",
        plugin="obstacle_avoidance_planner::ObstacleAvoidancePlanner",
        name="obstacle_avoidance_planner_custom",
        namespace="",
        remappings=[
    ...
    obstacle_stop_planner_component = ComposableNode(
        ...
        remappings=[
            ...
            ("~/output/trajectory", "/planning/obstacle_stop_planner/trajectory"),
    ...
    obstacle_cruise_planner_relay_component = ComposableNode(
        ...
        parameters=[
            ...
            {"output_topic": "/planning/obstacle_stop_planner/trajectory"},
